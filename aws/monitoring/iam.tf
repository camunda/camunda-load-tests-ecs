...
# Discovery sidecar permissions for AWS Cloud Map
# Required for the sidecar container to list Cloud Map namespaces
# and discover benchmark orchestration-cluster targets dynamically
resource "aws_iam_policy" "prometheus_ecs_discovery" {
  name = "${var.prefix}-prometheus-ecs-discovery"
